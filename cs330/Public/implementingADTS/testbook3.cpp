...
void Book3Suite::testSimpleConstructor()
{
  Author au ("J. Doe");
  Book b (au);
...
void Book3Suite::testArrayBasedConstructor()
{
...
void Book3Suite::testRemoveAuthor()
{
  const Author au1 ("J. Doe");
  const Author au2 ("S. Jones");
  const Author au3 ("M. Smith");
